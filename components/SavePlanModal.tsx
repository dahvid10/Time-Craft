...
export const SavePlanModal: React.FC<SavePlanModalProps> = ({ onClose, onSave }) => {
            ...
            >
                ...
                <div className="p-6 border-b border-gray-200 dark:border-slate-700">
                    <div className='flex items-center gap-3'>
                        <div className="bg-indigo-500/20 p-2 rounded-full text-indigo-600 dark:text-indigo-400">
                            <SaveIcon />
                        </div>
                        <h2 className="text-xl font-bold text-indigo-600 dark:text-indigo-400">Save New Plan</h2>
                    </div>
                </div>
                
                <div className="p-6 space-y-4">
                    <div>
                        <label htmlFor="plan-name" className="block text-sm font-medium text-gray-600 dark:text-slate-300 mb-1">Plan Name <span className="text-red-500">*</span></label>
                        <input
                            type="text"
                            id="plan-name"
                            value={planName}
                     ...
                     <div>
                        <label htmlFor="plan-budget" className="block text-sm font-medium text-gray-600 dark:text-slate-300 mb-1">Budget (Optional)</label>
